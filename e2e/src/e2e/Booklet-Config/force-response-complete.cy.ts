...
// TODO check response-complete hier wieder aktivieren (skip entfernen), wenn stabil headless läuft
/*
...
describe.skip('check parameter: response-complete', { testIsolation: true }, () => {
  ...
  it('OFF (default): forward', () => {
    loginTestTaker('Bklt_Config-8', '123');
  ...
  it('ON: forward', () => {
    loginTestTaker('Bklt_Config-9', '123');
  ...
  it('ALWAYS: forward', () => {
    loginTestTaker('Bklt_Config-10', '123');
    cy.get('[data-cy="page-navigation-forward"]')
      .click();
    //wait for presentation-complete
    cy.wait(2000);
