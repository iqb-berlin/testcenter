...
final class SessionControllerTest extends TestCase {
  ...
  public function test_putSessionLogin_loginThatRequiresCode(): void {
    ...
    $this->assertEquals(
      '{"token":"some_token","displayName":"Sample Group\/sample_user","id":null,"customTexts":{},"flags":["codeRequired"],"claims":{},"groupToken":"group-token","access":{}}',
  ...
  public function test_putSessionLogin_returnPersonSessionIfNoCodeRequired(): void {
    ...
    $this->assertEquals(
      '{"token":"new_token","displayName":"Sample Group\/sample_user","id":null,"customTexts":{},"flags":[],"claims":{"test":[{"id":"THE_BOOKLET","type":"test","label":"Label of THE_BOOKLET","flags":{"locked":true,"running":false}}]},"groupToken":"group-token","access":{"test":["THE_BOOKLET"]}}',
      $response->getBody()->getContents()
    );
    $this->assertEquals(200, $response->getStatusCode());
  }
  ...
  public function test_putSessionAdmin(): void {
    ...
    $this->assertEquals(
      '{"token":"admin_token","displayName":"Admin1","id":1,"customTexts":{},"flags":[],"claims":{"workspaceAdmin":[{"id":"1","type":"workspaceAdmin","label":"ws1","flags":{"mode":"Workspace 1"}}],"superAdmin":[]},"groupToken":null,"access":{"workspaceAdmin":["1"],"superAdmin":[]}}',
      $response->getBody()->getContents()
    );
    $this->assertEquals(200, $response->getStatusCode());
  }
  ...
  public function test_getSession_loginSession() {
    ...
    $this->assertEquals(
      '{"token":"login_token","displayName":"Sample Group\/sample_user","id":null,"customTexts":{},"flags":["codeRequired"],"claims":{},"groupToken":"group-token","access":{}}',
      $response->getBody()->getContents()
    );
  }
  ...
  public function test_getSession_personSession() {
    ...
    $this->assertEquals(
      '{"token":"person_token","displayName":"Sample Group\/sample_user\/xxx","id":null,"customTexts":{},"flags":[],"claims":{"test":[{"id":"THE_BOOKLET","type":"test","label":"Label of THE_BOOKLET","flags":{"locked":true,"running":false}}]},"groupToken":"group-token","access":{"test":["THE_BOOKLET"]}}',
      $response->getBody()->getContents()
    );
  }
  ...
  public function test_getSession_adminSession() {
    ...
    $this->assertEquals(
      '{"token":"admin_token","displayName":"super","id":1,"customTexts":{},"flags":[],"claims":{"workspaceAdmin":[{"id":"1","type":"workspaceAdmin","label":"workspace","flags":{"mode":"RW"}}],"superAdmin":[]},"groupToken":null,"access":{"workspaceAdmin":["1"],"superAdmin":[]}}',
      $response->getBody()->getContents()
    );
  }
