...
class WorkspaceInitializer {
  const sampleDataPaths = [
    ...
    "system-test" => [
      ...
      "sampledata/system-test/CY_BKL_NavRestr_Bklt-0.xml" => "Booklet/CY_BKL_NavRestr_Bklt-0.xml",
      "sampledata/system-test/CY_BKL_NavRestr_Bklt-1.xml" => "Booklet/CY_BKL_NavRestr_Bklt-1.xml",
      "sampledata/system-test/CY_BKL_NavRestr_Bklt-2.xml" => "Booklet/CY_BKL_NavRestr_Bklt-2.xml",
      "sampledata/system-test/CY_BKL_NavRestr_Bklt-3.xml" => "Booklet/CY_BKL_NavRestr_Bklt-3.xml",
      "sampledata/system-test/CY_BKL_NavRestr_Testlet-1.xml" => "Booklet/CY_BKL_NavRestr_Testlet-1.xml",
      "sampledata/system-test/CY_BKL_NavRestr_Testlet-2.xml" => "Booklet/CY_BKL_NavRestr_Testlet-2.xml",
      "sampledata/system-test/CY_BKL_NavRestr_Testlet-3.xml" => "Booklet/CY_BKL_NavRestr_Testlet-3.xml",
      ...
      "sampledata/system-test/CY_Logins_SM.xml" => "Testtakers/CY_Logins_SM.xml",
      "sampledata/system-test/CY_Logins_TestController.xml" => "Testtakers/CY_Logins_TestController.xml",
      "sampledata/system-test/CY_Logins_BkltConfig.xml" => "Testtakers/CY_Logins_BkltConfig.xml",
