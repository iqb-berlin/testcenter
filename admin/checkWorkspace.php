								...
								if (is_file($fullfilename) && (strtoupper(substr($entry, -4)) == '.XML')) {
									...
									if ($xFile->isValid()) {
										...
										if ($xmlfile != false) {
											...
											if ($rootTagName == 'Unit') {
												// ..........................
												$unitId = (string) $xmlfile->Metadata[0]->ID[0];
												if (isset($unitId)) {
													...
													if (in_array($unitId, $allUnits)) {
														...
														$resourcesElement = $xmlfile->Resources[0];
													...
													array_push($myreturn['warnings'], 'no unit id found in Unit-XML-file "' . $entry . '"');
												}
												// ..........................
											} else {
									...
									if ($xFile->isValid()) {
										...
										if ($xmlfile != false) {
											...
											if ($rootTagName == 'Booklet') {
												// ..........................
												$bookletId = (string) $xmlfile->Metadata[0]->ID[0];
												if (isset($bookletId)) {
													$bookletId = strtoupper($bookletId);
																...
																if ($unitsElement->count() > 0) {
																	...
																	foreach($unitsElement->children() as $u) { 
																		...
																		if (isset($unitName)) {
																			...
																			if (!in_array($unitName, $allUnits)) {
																				array_push($myreturn['errors'], 'unit "' . $unitName . '" not found (required in Booklet-XML-file "' . $entry . '" (ignore booklet)');
																				$unitsOK = false;
																			}
																		}
																	}
													...
													array_push($myreturn['warnings'], 'no booklet id found in Booklet-XML-file "' . $entry . '"');
												}
												// ..........................
											} else {
